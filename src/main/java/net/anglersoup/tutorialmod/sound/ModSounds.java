package net.anglersoup.tutorialmod.sound;
...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> ROBERT_SCREAM = registerSoundEvents("robert_scream");
    public static final RegistryObject<SoundEvent> ROBERT_LAUGH = registerSoundEvents("robert_laugh");
