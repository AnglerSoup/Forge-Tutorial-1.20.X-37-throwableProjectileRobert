package net.anglersoup.tutorialmod.item;
...
import net.anglersoup.tutorialmod.item.custom.*;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> ROBERT = ITEMS.register("robert",
            () -> new RobertItem(new Item.Properties()));
