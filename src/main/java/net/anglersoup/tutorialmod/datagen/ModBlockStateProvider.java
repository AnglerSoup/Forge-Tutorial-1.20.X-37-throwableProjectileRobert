package net.anglersoup.tutorialmod.datagen;

import net.anglersoup.tutorialmod.TutorialMod;
import net.anglersoup.tutorialmod.block.ModBlocks;
import net.anglersoup.tutorialmod.block.custom.CornCropBlock;
import net.anglersoup.tutorialmod.block.custom.StrawberryCropBlock;
